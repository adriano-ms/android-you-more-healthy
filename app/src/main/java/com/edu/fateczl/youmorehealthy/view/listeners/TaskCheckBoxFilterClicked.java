...
public class TaskCheckBoxFilterClicked implements View.OnClickListener {
    ...
    public TaskCheckBoxFilterClicked(RecyclerView recyclerView, TaskCardClickListener cardClickListener, TaskController controller, Map<TaskType, CheckBox> checkBoxMap){
    ...
    public void onClick(View v) {
        ...
        recyclerView.setAdapter(new RVTaskAdapter(controller.listFiltered(types), cardClickListener));
    }
}
