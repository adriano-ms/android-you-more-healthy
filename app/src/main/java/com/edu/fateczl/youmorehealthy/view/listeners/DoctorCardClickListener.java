...
public class DoctorCardClickListener implements OnCardClickListener<Doctor> {

    private final FragmentManager fragmentManager;
    public DoctorCardClickListener(FragmentManager fragmentManager){
        this.fragmentManager = fragmentManager;
    }

    @Override
    public void onCardClick(CardView cardView, Doctor obj) {
        ViewUtils.clickAnimation(cardView, () -> {
            Fragment f = FragmentFactory.createDoctorFragment(obj);
